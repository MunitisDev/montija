...
export const EN = {
  ...
  'event.wolves': 'Wolves! Everyone to the village',
  'event.wolvesTook': 'Wolves took food left in the open',
  'event.wolvesKilled': 'Someone was killed by the wolves',
  'event.wolvesSlain': 'A wolf was killed',
  ...
  'guide.hardship.wolves.detail':
    'From the settlement\u2019s second autumn onwards, packs come down in the hungry half of the year \u2014 never in spring or summer. You will see them come out of the trees, and the moment anyone spots them the whole village knows: the children and the old go indoors, and everybody of working age takes a tool and goes out at them. A wolf is worth a person, so numbers decide it \u2014 two wolves will kill one villager and two villagers will kill one wolf, and nobody wins a fair one against one. Bare hands lose: keep tools on the shelf. They will not cross a wall, they will chew through timber if you leave them to it, and they will not come more than six paces out of cover \u2014 so cleared ground is a defence too.',
...
export const ES: Messages = {
  ...
  'event.wolves': '¡Lobos! Todos al pueblo',
  'event.wolvesTook': 'Los lobos se han llevado comida que estaba fuera',
  'event.wolvesKilled': 'Los lobos han matado a alguien',
  'event.wolvesSlain': 'Han matado a un lobo',
  ...
  'guide.hardship.wolves.detail':
    'Desde el segundo oto\u00f1o del asentamiento, las manadas bajan en la mitad hambrienta del a\u00f1o \u2014 nunca en primavera ni en verano. Los ver\u00e1s salir de los \u00e1rboles, y en cuanto alguien los ve lo sabe todo el pueblo: los ni\u00f1os y los viejos se meten en casa, y todo el que est\u00e1 en edad de trabajar coge una herramienta y sale a por ellos. Un lobo vale lo que una persona, as\u00ed que lo deciden los n\u00fameros: dos lobos matan a un aldeano y dos aldeanos matan a un lobo, y nadie gana un uno contra uno. A manos desnudas se pierde: ten herramientas en el almac\u00e9n. No cruzan una muralla, se roen la madera si les das tiempo, y no se alejan m\u00e1s de seis pasos de la espesura \u2014 as\u00ed que el terreno talado tambi\u00e9n defiende.',
